...
function Group-DevicesByModel {
    ...
    param (
        ...
        [string]
        $DeviceType = "Output"  # Tipo de dispositivo de sa�da
    )
    ...
    process {
        ...
        try {
            ...
            Write-Host "Erro durante a execucao da funcao Group-DevicesByModel: $_"
        }
        finally {
...
$rootGroupName = "Instalacao"
$baseGroupPath = "/$rootGroupName"
Group-DevicesByModel -BaseGroupPath $baseGroupPath -DeviceType "Output"
